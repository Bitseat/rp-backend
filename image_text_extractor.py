...
# exploring the directory for all jpg files
    for file in os.listdir(file_dir + "/resumes"):
        ...
        # displaying image and saving in the directory
            ...
            scanned_file_name = file_dir + "/resumes/" + str(file) + ".png" 
        ...
        # fetching text from the image and storing it into a text file
            ...
            text_file_name = file_dir +"/resumes/" + str(file) + ".txt"

            ### if we need the jpg extension
            word_file_name = file_dir +"/resumes/" + str(file) 
            ### if we don't need the jpg extension
            #word_file_name = file_dir +"/resumes/" + str(file[:-4]) + ".docx"
    ...
    for i in os.listdir(file_dir + "/resumes"):
        document = Document()
